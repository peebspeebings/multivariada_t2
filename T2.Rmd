...
O algoritmo subdividiu a amostra de forma que o primeiro grupo tenha maior popularity, danceability, energy, loudness, speechiness, liveness, valence e tempo. As durações das músicas foram similares para ambos clusters.
